...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				models_list_read_max_bytes INTEGER NOT NULL DEFAULT 8388608,
					...
					codex_priority_service_tier_enabled INTEGER DEFAULT 0,
					codex_priority_service_tier_min_remaining_ratio REAL DEFAULT 0.5,
	...
	columns := []struct {
		...
		{"system_settings", "auto_reset_credits_low_balance_enabled", "INTEGER DEFAULT 0"},
		...
		{"system_settings", "codex_priority_service_tier_enabled", "INTEGER DEFAULT 0"},
		{"system_settings", "codex_priority_service_tier_min_remaining_ratio", "REAL DEFAULT 0.5"},
